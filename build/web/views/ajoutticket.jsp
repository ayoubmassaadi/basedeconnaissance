...
//                        erreur.innerHTML="You must select a probléme";
//                        erreur.style.color="red";
//                        return false;  
//                    }
//                    if(textArea.value===""){
//                        erreurText.innerHTML="you must write your probléme";
//                        erreurText.style.color="red";
//                        return false;
//                    }
//                    
...
//                    }else{ messagetel.style.display= "none";}
                    ...
                    if(securityQuestionElement.value==="") {  
                        // window.alert('You must select a Security Question');  
                        // securityQuestionElement.value = 'm'
                        erreur.innerHTML="Selectionnez un problème";
                        erreur.style.color="red";
                        return false;  
                    }
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
            ...
            <li class="nav-item  d-none d-lg-flex">
              ...
              <a style="color:grey; font-weight:lighter;" class="nav-link" href="ajoutticket.jsp">
                Hardware
              </a>
                <a style="color:grey; font-weight:lighter;" class="nav-link" href="softwareTicket.jsp">
                Software
              </a>
            </li>
        </ul>
...
<!--              <div class="nav-search">
      ...
      <div class="main-panel"><div>
        <div class="col-lg-10 stretch-card">
          <div class="card">
            <div class="card-body">
                  <h4 class="card-title">Créez votre ticket hardware : </h4>
                  <form onsubmit="return checkDropdown()" action="../Ajoutticket" method="GET">
                    <div class="form-group">
                      <label for="exampleInputName1">nom</label>
                      <input readonly type="text" class="form-control" id="nom" placeholder="Nom" name="nom" value="<%=data.getString("nom_employe")%>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">prenom</label>
                      <input readonly type="text" class="form-control" id="prenom" placeholder="Prénom" name="prenom" value="<%=data.getString("prenom_employe")%>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">email</label>
                      <input readonly type="email" class="form-control" id="email" placeholder="Email" name="email" value="<%=data.getString("EMAIL_EMPLOYE")%>">
                    </div>
               <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleSelectGender">Type du problème</label>
                        <select id="seleProbleme" class="form-control" name="typeProb">
                          ...
                          <option >Telephone fix</option>
                        </select>
                      <p id="erreurSelect"></p>
                      </div>
              <div class="form-group">
                      <label for="exampleTextarea1">Description du probléme :</label>
                      <textarea class="form-control" id="description" rows="4" name="description" placeholder="Decrivez votre probleme"></textarea>
