...
<!--                <li class="nav-item"> <a class="nav-link" href="ajoutticket.jsp">Creer un ticket</a></li>-->
      ...
      <!-- partial -->
    <%
        ResultSet data=MyConnection.getMyConnection().createStatement().executeQuery("select * from "
            + "historiquedemande join intervenant on(historiquedemande.ID_INTERVENANT=intervenant.ID_INTERVENANT)");
    %>
      <div class="main-panel">          
        <div>
          <div class="col-lg-10 stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Les demandes résolues</h4>
                </p> 
                    ...
                    <div ng-controller='inboxCtrl'>
                        ...
                        <%while(data.next()){%>  
                          <tr ng-repeat = "mail in mails">
                            <td><%=data.getString("PRENOM_INTERVENANT")+" "+data.getString("NOM_INTERVENANT")%></td>
                            ...
                            <td><%=data.getDate("DATE_CREATION_DEMANDE")%></td>
