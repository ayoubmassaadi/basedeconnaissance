            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle  pl-0 pr-0" href="#" data-toggle="dropdown" id="profileDropdown">
                ...
                <%
                    ...
                    sess.setAttribute("idticketaffecte", request.getParameter("idticketaffecte"));
                    Connection con;
                    Statement state;
                    con=MyConnection.getMyConnection();
                    state=con.createStatement();
//                    state.executeUpdate("update demande set ID_INTERVENANT="+id+" where ID_DEMANDE="+request.getParameter("idDemande"));
                %>
                <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle  pl-0 pr-0" href="#" data-toggle="dropdown" id="profileDropdown">
...
<!--                        <li class="list-inline-item g-mr-20">
    ...
    <div>        
        <form class="algin-form" action="../SolutionTicket" method="GET">
        <div class="align-fr">  
